...
export function ScoreTitlePreview(selectedStyle: any, setSelectedStyle: Function, title: string, subtitle: string, composer: string, mvtNo: string, pieceNumber: number, ) {
