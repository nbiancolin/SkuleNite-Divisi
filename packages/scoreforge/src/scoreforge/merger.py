        ...
        for base_idx in range(len(base_measures)):
            ...
            while user_insertions_idx < len(user_insertions_sorted):
                ...
                merged_measures.append(
                    Measure(number=out_measure_num, voices=_copy_voices(user_measures[ui]),
                            ...
                            measure_repeat_count=user_measures[ui].measure_repeat_count,
                            double_bar=user_measures[ui].double_bar)
                )
                out_measure_num += 1
            ...
            while head_insertions_idx < len(head_insertions_sorted):
                ...
                merged_measures.append(
                    Measure(number=out_measure_num, voices=_copy_voices(head_measures[hi]),
                            ...
                            measure_repeat_count=head_measures[hi].measure_repeat_count,
                            double_bar=head_measures[hi].double_bar)
                )
                out_measure_num += 1
            ...
            if head_meas and user_meas:
                if base_hash == head_hash == user_hash:
                    merged_measures.append(
                        Measure(number=out_measure_num, voices=_copy_voices(base_meas),
                                ...
                                measure_repeat_count=base_meas.measure_repeat_count,
                                double_bar=base_meas.double_bar)
                    )
                    ...
                    merged_measures.append(
                        Measure(number=out_measure_num, voices=_copy_voices(user_meas),
                                ...
                                measure_repeat_count=user_meas.measure_repeat_count,
                                double_bar=user_meas.double_bar)
                    )
                    ...
                    merged_measures.append(
                        Measure(number=out_measure_num, voices=_copy_voices(head_meas),
                                ...
                                measure_repeat_count=head_meas.measure_repeat_count,
                                double_bar=head_meas.double_bar)
                    )
                ...
                if base_hash == head_hash:
                    ...
                    empty_meas = Measure(number=out_measure_num, voices={"0": []}, double_bar=False)
